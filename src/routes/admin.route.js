...
import { createCategory, createDeal, deleteProduct, editCategory, editDeals, editProduct, getAllAdminProducts } from "../controllers/porduct.controller.js";
...
adminRoute.route('/delete-category/:id')
